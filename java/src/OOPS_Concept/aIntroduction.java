...
/*	
 		* OOPS in Java stands for " Object Oriented Programming System "
 		...
 		Purpose :-
 		------------
 		* OOPS Concept purpose in Java is to " represent the 'real world entities' as 'object' in our programming code "
 		
 		Real World Entities :
 		eg :- Physical things like " Laptop, Bootle, Pen, Mobile, Mouse, MobileCharger, Wallet, Table, Chair etc.... "
 		...
 		1. Class is a " Template/Blueprint " which can be used for creating Objects
 			eg :For constructing house we want a " Plan " (OR) " Template/Blueprint ", by using this plan we can construct (OR) create real world Objects
 			...
 			Class (Template/Blueprint)											Object (Real world entity)
 					...
 					Running															Name : Piper Colour : White
